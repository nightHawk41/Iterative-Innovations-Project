...
class Notification(db.Model):
    ...
    slot_id = db.Column(db.String(5), db.ForeignKey("item_slot.slot_id"), nullable=False)
    message = db.Column(db.String(100), nullable=False)
    alert_level = db.Column(db.String(10), nullable=False)   # "warning" | "critical"
    date_triggered = db.Column(db.DateTime, nullable=False, default=datetime.utcnow)
    ...
    def __init__(self, slot_id: str, message: str, alert_level: str, date_triggered=None):
        ...
        self.date_triggered = date_triggered or datetime.utcnow()
